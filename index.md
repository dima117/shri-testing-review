...
- не все важны есценарии покрыты тестами
- интеграционные тесты вместо модульных
</div>

## Алгоритм

**Всё, что возможно проверить модульными тестами. Остальное — интеграционными.**

  - разбить логические блоки на блоки
